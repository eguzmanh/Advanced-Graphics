...
{	public Utils() {}
	...
	// neutral white material
	public static float[] whiteAmbient() { return (new float[] {0.5f, 0.5f, 0.5f, 1}); }
	public static float[] whiteDiffuse() { return (new float[] {0.9f, 0.9f, 0.9f, 1}); }
	public static float[] whiteSpecular() { return (new float[] {1.0f, 1.0f, 1.0f, 1}); }
	public static float whiteShininess() { return 32.0f; }
